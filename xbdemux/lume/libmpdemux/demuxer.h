...
#define DEMUXER_TYPE_ISDBT 48

#define DEMUXER_TYPE_UNKNOWN_STR "UNKNOWN"
#define DEMUXER_TYPE_MPEG_ES_STR "MPEG_ES"
#define DEMUXER_TYPE_MPEG_PS_STR "MPEG_PS"
#define DEMUXER_TYPE_AVI_STR "AVI"
#define DEMUXER_TYPE_AVI_NI_STR "AVI_NI"
#define DEMUXER_TYPE_AVI_NINI_STR "AVI_NINI"
#define DEMUXER_TYPE_ASF_STR "ASF"
#define DEMUXER_TYPE_MOV_STR "MOV"
#define DEMUXER_TYPE_VIVO_STR "VIVO"
#define DEMUXER_TYPE_TV_STR "TV"
#define DEMUXER_TYPE_FLI_STR "FLI"
#define DEMUXER_TYPE_REAL_STR "REAL"
#define DEMUXER_TYPE_Y4M_STR "Y4M"
#define DEMUXER_TYPE_NUV_STR "NUV"
#define DEMUXER_TYPE_FILM_STR "FILM"
#define DEMUXER_TYPE_ROQ_STR "ROQ"
#define DEMUXER_TYPE_MF_STR "MF"
#define DEMUXER_TYPE_AUDIO_STR "AUDIO"
#define DEMUXER_TYPE_OGG_STR "OGG"
#define DEMUXER_TYPE_RAWAUDIO_STR "RAWAUDIO"
#define DEMUXER_TYPE_RTP_STR "RTP"
#define DEMUXER_TYPE_RAWDV_STR "RAWDV"
#define DEMUXER_TYPE_PVA_STR "PVA"
#define DEMUXER_TYPE_SMJPEG_STR "SMJPEG"
#define DEMUXER_TYPE_XMMS_STR "XMMS"
#define DEMUXER_TYPE_RAWVIDEO_STR "RAWVIDEO"
#define DEMUXER_TYPE_MPEG4_ES_STR "MPEG4_ES"
#define DEMUXER_TYPE_GIF_STR "GIF"
#define DEMUXER_TYPE_MPEG_TS_STR "MPEG_TS"
#define DEMUXER_TYPE_H264_ES_STR "H264_ES"
#define DEMUXER_TYPE_MATROSKA_STR "MATROSKA"
#define DEMUXER_TYPE_REALAUDIO_STR "REALAUDIO"
#define DEMUXER_TYPE_MPEG_TY_STR "MPEG_TY"
#define DEMUXER_TYPE_LMLM4_STR "LMLM4"
#define DEMUXER_TYPE_LAVF_STR "LAVF"
#define DEMUXER_TYPE_NSV_STR "NSV"
#define DEMUXER_TYPE_VQF_STR "VQF"
#define DEMUXER_TYPE_AVS_STR "AVS"
#define DEMUXER_TYPE_AAC_STR "AAC"
#define DEMUXER_TYPE_MPC_STR "MPC"
#define DEMUXER_TYPE_MPEG_PES_STR "MPEG_PES"
#define DEMUXER_TYPE_MPEG_GXF_STR "MPEG_GXF"
#define DEMUXER_TYPE_NUT_STR "NUT"
#define DEMUXER_TYPE_LAVF_PREFERRED_STR "LAVF_PREFFRRED"
#if defined(WORK_AROUND_FOR_CTS_MEDIAPLAYERFLAKY_OPENDEMUX)
#define DEMUXER_CTS_MEDIA_FLAKY "CTS_MEDIA_FLAKY"
#endif
...
typedef struct demux_packet {
  ...
  double endpts;
  double stream_pts;
  loff_t pos;  // position in index (AVI) or file (MPG)
...
typedef struct {
  ...
  loff_t pos;                 // position in the input stream (file)
  loff_t dpos;                // position in the demuxed stream
...
typedef struct demuxer {
  ...
  loff_t filepos; // input stream current pos.
  loff_t movi_start;
  loff_t movi_end;  
  stream_t *stream;
  ...
  int a_changed_id; //changed audio id after select
  int s_changed_id; //changed sub id after select
  char *audio_info; //audio track info
  char *sub_info; //sub track info
  int ists;
  int tssub_cnt;  
  int64_t start_time;//the first frame pts; added by gjwang
  int last_sample;
  int changeAudioFlag; //lost frame when swicth audio track(dts) 
  int ttaflag;
  int matroflag;
  void *glinfo;
} demuxer_t;
...
void ds_read_packet(demux_stream_t *ds, stream_t *stream, int len, double pts, loff_t pos, int flags);

int demux_fill_buffer(demuxer_t *demux,demux_stream_t *ds);
int ds_fill_buffer(demux_stream_t *ds);

static inline loff_t ds_tell(demux_stream_t *ds){
...
int ds_parse(demux_stream_t *sh, uint8_t **buffer, int *len, double pts, loff_t pos);
