...
PRODUCT_COPY_FILES += \
	...
	$(GPU_SGX540_LOCAL_PATH)/hw/hwcomposer.xxx.so:system/lib/hw/hwcomposer.xb4780.so    \
	$(GPU_SGX540_LOCAL_PATH)/hw/memtrack.xxx.so:system/lib/hw/memtrack.xb4780.so        \
